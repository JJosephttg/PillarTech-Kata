...
namespace CheckoutOrderTotalLib {
    ...
    */
    public class CheckoutOrderManager {
        ...
        public void SetProductUnitPrice(string groceryItem, double price) => _groceryPriceMap[groceryItem] = price;
        ...
        public void RemoveScannedItem(string groceryItem) => _checkoutOrder.Remove(_checkoutOrder.LastOrDefault(x => x.Name == groceryItem));

        public double GetTotalPrice() => _checkoutOrder.Sum(x => x.Price);
    }
}
